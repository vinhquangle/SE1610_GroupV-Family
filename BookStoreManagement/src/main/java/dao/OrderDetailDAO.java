...
public class OrderDetailDAO {
    ...
    private static final String LOAD_ORDER_DETAIL_BY_ORDER_ID = "SELECT d.detailID, d.orderID, d.ISBN, d.Price, d.Quantity, d.Total, d.[status],\n"
            ...
            + "o.customerID, o.staffID, o.promotionID, o.[Address], o.[Date], o.[Delivery-cost], o.Total AS 'orderTotal', o.[Description] AS 'orderDes', o.[status] AS 'orderStatus', o.[Delete],\n"
                    ...
                    listOrderDetail.add(new OrderDetailDTO(detailID,
                            new OrderDTO(orderID,
                                    ...
                                    new PromotionDTO(promotionID,
                                            new StaffDTO(staffIDP, staffNameP, "***", roleP, staffPhoneP, dobP, staffStatusP, staffDeleteP), dateS, dateE, proDes, condition, discount, proStatus), addr, deliCost, date, orderTotal, orderDes, orderStatus, delete),
                            new BookDTO(isbn,
