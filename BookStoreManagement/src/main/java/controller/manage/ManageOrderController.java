    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "                                <input readonly=\"\" style=\"margin-bottom: 25px;\" placeholder=\"Trống\" value=\"" + currencyVN.format(order.getSubtotal()) + "\">\n"
                    + "                                <div><b>Phần trăm khuyến mãi</b></div>\n"
                    + "                                <input readonly=\"\" style=\"margin-bottom: 25px;\" placeholder=\"Trống\" value=\"" + order.getDiscount() + "%\">\n"
