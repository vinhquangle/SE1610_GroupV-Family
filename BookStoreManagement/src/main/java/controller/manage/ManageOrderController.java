    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "                                <textarea rows=\"2\" style=\"width: 100%;\" readonly=\"\" style=\"margin-bottom: 25px; \" placeholder=\"Nội dung khuyến mãi\">" + order.getPromotion().getDescription() + "</textarea>\n"
                    + "                                <div><b>Phí vận chuyển</b></div>\n"
                    + "                                <input readonly=\"\" style=\"margin-bottom: 25px;\" placeholder=\"Trống\" value=\"" + currencyVN.format(order.getDeliveryCost()) + "\">\n"
                    + "                            </div>\n"
                    + "                            <div class=\"col-md-8\">\n"
            ...
            out.println("                        </div>\n"
                    ...
                    + "                            </div>\n"
                    + "                            <div class=\"col-md-3\">\n"
                    + "                        <h3><p><b>Tổng thành tiền: " + currencyVN.format(order.getTotal()) + "</b></p></h3>\n"
                    + "                            </div>\n"
                    + "                            </div>\n"
            ...
            for (OrderDTO orderDTO : listOrder) {
                ...
                out.println("                              <tr>\n"
                        ...
                        + "                                    <td>" + orderDTO.getStaff().getName() + "</td>\n"
                ...
                out.println("                                    <td>\n"
                        + "                                        <button id=\"edit\" onclick=\"updateOrder('ManageOrderController?index=" + index + "','" + index + "','" + status + "','" + search + "','load','" + orderDTO.getOrderID() + "')\" data-toggle=\"tooltip\" title=\"Thông tin chi tiết\" class=\"pd-setting-ed\"><i class=\"fa fa-info-circle\" aria-hidden=\"true\"></i></button>\n"
                        + "                                   </td>\n"
                        + "                                </tr>"
                );
            }
