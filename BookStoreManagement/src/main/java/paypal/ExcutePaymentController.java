    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ship.equals("YES")) {
                ...
                orderID = orderDao.insertOrderOnlineShip(cus.getCustomerID(), promotion, address, feeShip, total + feeShip, des);
            } else if (ship.equals("NO")) {
                orderID = orderDao.insertOrderOnlineStore(cus.getCustomerID(), promotion, 0, total, des);
            }
            total = 0;
            for (BookDTO book : cart.getCart().values()) {
