 ...
 * @author Quang Vinh
 */
public class InsertBookRequest extends HttpServlet {
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                ...
                try {
                    ...
                    mess = "<div class=\"row\">\n"
                            ...
                            + "                            </div>\n"
                            + "                         <div class=\"col-md-9\">\n"
                            + "                             <p style=\"color: red;\"><b>Thêm \"" + book.getName() + "\" - số lượng " + quantity + "  vào danh sách yêu cầu thất bại</b></p>\n"
                ...
                if (quantity > quantityCheck) {
                    mess = "<div class=\"row\">\n"
                            ...
                            + "                         <div class=\"col-md-9\">\n"
                            + "                             <p style=\"color: red;\"><b>Thêm \"" + book.getName() + "\" - số lượng " + quantity + "  vào danh sách yêu cầu thất bại</b></p>\n"
                            + "                             <p style=\"color: red;\"><b>(Số lượng yêu cầu không có sẵn - Hiện tại còn " + quantityCheck + " sản phẩm)</b></p>\n"
                            + "                                </div>\n"
                            + "                            </div>";
                    throw new Exception();
                }
                ...
                if (use != null) {
                    if (use.equals("Add")) {
                        ...
                        mess = "<div class=\"row\">"
                                ...
                                + "                             <p style=\"color: green;\"><b>Thêm vào danh sách yêu cầu thành công</b></p>\n"
                                + "                         </div>\n"
                                + "                     </div>\n"
                                + "                     <div class=\"row\">\n"
                                + "                         <div class=\"col-md-3\">\n"
                        ...
                        if (cart != null) {
                            mess = "<div class=\"row\">"
                                    + "                         <div style=\"text-align: center\" class=\"col-md-12\">\n"
                                    + "                             <p style=\"color: #f58005;\"><b>Đã xóa sản phẩm khỏi yêu cầu</b></p>\n"
                                    + "                         </div>\n"
                                    + "                     </div>\n"
                                    + "                     <div class=\"row\">\n"
                                    + "                         <div class=\"col-md-3\">\n"
                        ...
                        if (quantity > quantityCheck) {
                            mess = " <div class=\"row\">\n"
                                    ...
                                    + "                            </div>\n"
                                    + "                         <div class=\"col-md-9\">\n"
                                    + "                             <p style=\"color: red;\"><b>Thay đổi \"" + book.getName() + "\" - số lượng " + quantity + "  trong danh sách yêu cầu thất bại</b></p>\n"
                                    + "                             <p style=\"color: red;\"><b>(Số lượng yêu cầu không có sẵn - Hiện tại còn " + quantityCheck + " sản phẩm)</b></p>\n"
                                    + "                                </div>\n"
                                    + "                            </div>";
                            throw new Exception();
            ...
            log("Error at InsertBookRequest: " + e.toString());
        } finally {
