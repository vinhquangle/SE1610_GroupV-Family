    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div style="background-color: #1e1e27; color: white; font-weight: bold; font-size: 15px; border-radius: 10px;" class="row">
                            ...
                            <div style="border-left: 2px solid white;" class="col-md-2">Số lượng</div>
                    ...
                    <div style="border: 1px solid #dedede; height: 100%; margin-left: 10px; margin-top: 100px;" class="col-md-12">
                        ...
                        <div class="order-summary">
                            ...
                            <div class="order-col">
                                ...
                                <div><strong class="order-total"><input id="total" type="hidden" readonly="" style="border: none; width: 100%" ></strong></div>
                            </div>
                            <form action="SendRequestController" method="GET">
                                <button name="action" value="Request" style="color: white; cursor: pointer; width: 100%;" class="primary-btn order-submit">Tạo yêu cầu</button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <script>
            function loadCreate(searchBook, index) {
                ...
                $.ajax({
                    url: "/BookStoreManagement/AddBookRequestController",
            ...
            function loadAdd(quantity, isbn, quantityCheck, use) {
                ...
                $.ajax({
                    url: "/BookStoreManagement/InsertBookRequest",
                    type: "post", //send it through get method
                    data: {
                        quantity: quantity,
                        isbn: isbn,
