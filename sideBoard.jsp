                        ...
                        <ul class="metismenu" id="menu1">
                            <li>
                                ...
                                <ul class="submenu-angle" aria-expanded="false">
                                    ...
                                    <li><a onclick="load('ManageBookResponseController')" title="Book Responding" href="#"><i class="fa fa-level-down sub-icon-mg" aria-hidden="true"></i><span class="mini-sub-pro">Phản hồi nhập sách</span></a></li>
                                </ul>
                            </li>
                            <li>
