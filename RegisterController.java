    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!valid) {
                ...
                if (checkDuplicateID==true || ScheckDuplicateID==true || (checkDuplicateID==true &&ScheckDuplicateID==true)) {
                ...
                if (checkValidation) {
                    boolean checkInsert = daoCus.register(new CustomerDTO(customerID, fullName, password, email, "", "", 0, "0", "0"));
                    if (checkInsert) {
                        url = SUCCESS;
                    }
                } else {
