                                                ...
                                                <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                    ...
                                                    <li class="nav-item">
                                                        ...
                                                        <ul style="background-color: white;" role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">   
                                                            <li><a onclick="load('ViewProfileStaffController')" style="color: #494f57;" href="#"><span style="color: #494f57;" class="fa fa-user author-log-ic"></span><b>My Profile</b></a></li>                                                        
                                                            <li><a style="color: #494f57;" href="login.html"><span style="color: #494f57;" class="fa fa-lock author-log-ic"></span><b>Log Out</b></a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </div>
