 ...
 * @author Quang Vinh
 */
public class AddBookRequestController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR AT AddBookRequestController : " + e.toString());
        } finally {
            ...
            if (list.size() > 0) {
                ...
                for (BookDTO book : list) {
                    ...
                    out.println("<div style=\"margin-top: 10px; margin-bottom: 5px; border: 1px solid #dedede;\" class=\"row\">\n"
                            ...
                            + "                                <div style=\"font-size: 12px; font-weight: bold;\" class=\"col-md-1\">" + book.getIsbn() + "</div>\n"
