<%-- 
    ...
    Author     : vungo
--%>
<!--Locate at WEB-INF/JSP/ManagePage/crudPromotion.jsp-->
...
//                return;
//            }
            String message= (String)request.getAttribute("MESSAGE_STAFF");
            if(message==null){
                message="";
            }
        ...
        %>
            ...
            <tbody>
                ...
                <tr>
                    <td><%=count++%></td>
                    <td><input type="text" name="promoID" value="<%=pro.getPromotionID()%>"></td>
                    <td><input type="text" name="staffS" value="<%=pro.getStaffID().getStaffID()%>"></td>
                    ...
                    <td><input type="text" name="statuspromo" value="<%=pro.getStatus()%>"></td>
                </tr>
                <%            
                        }
                %>
