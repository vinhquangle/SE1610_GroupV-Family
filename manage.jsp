...
<html>
    ...
    <body>
        ...
        <script>
            ...
            function loadResponse(a, index, status, b, use, responseID) {
                document.getElementById("content").innerHTML = "";
                if (index === "") {
                    index = "1";
                }
            ...
            function updateResponse(a, index, status, search, use, responseID) {
                loadResponse(a, index, status, search, use, responseID);
            }
        </script>
        <style>
            #edit:hover{
