...
<html>
    ...
    <body>
        ...
        <script>
            ...
            function updateOrder(a, index, status, search, use, orderID) {
                loadOrder(a, index, status, search, use, orderID);
            }
            function loadRevenue(a, index) {
                document.getElementById("content").innerHTML = "";
                if (index === "") {
                    index = "1";
                }
            ...
            function test() {
                var notice = document.getElementById("date").value;
                var date = notice.split('-');
            ...
            function loadRequest(a, index, b, requestID, use, reqB, staffID, date, status, del) {
                document.getElementById("content").innerHTML = "";
                if (index === "") {
                    index = "1";
                }
            ...
            function updateRequest(a, search, requestID, index, use) {
                loadRequest(a, index, search, requestID, use);
            }
            function req(a, use, index) {
                var b = document.getElementById("searchRequest").value;
                var reqB = document.getElementById("reqB").value;
                var requestID = document.getElementById("requestID").value;
                var staffID = document.getElementById("staffID").value;
                var date = document.getElementById("date").value;
                loadRequest(a, index, b, requestID, use, reqB, staffID, date, '1', '0');
            }
